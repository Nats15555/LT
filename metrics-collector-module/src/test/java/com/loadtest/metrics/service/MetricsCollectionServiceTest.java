...
class MetricsCollectionServiceTest {
    ...
    void getEffectiveUrl_resolvesHostAndQueryParamsBranches() {
        ...
        when(summarizationService.summarize(any(), any())).thenReturn(
                new MetricsCollectionResponse.SummaryResult("SUCCESS", "ok", null));
    ...
    void collectMetrics_partialAndFailedBranches() {
        ...
        MetricsCollectionRequest partialReq = new MetricsCollectionRequest(
                "t1",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r1", "GET", " ", null, null, null)),
                0, null, null);
        MetricsCollectionResponse partial = service.collectMetrics(partialReq);
        assertThat(partial.status()).isEqualTo("PARTIAL");
        assertThat(partial.metrics()).containsKey("r1");

        MetricsCollectionRequest failedReq = new MetricsCollectionRequest("t2", null, 0, null, null);
        MetricsCollectionResponse failed = service.collectMetrics(failedReq);
        assertThat(failed.status()).isEqualTo("FAILED");
        assertThat(failed.message()).contains("Failed to collect metrics");
    }
    ...
    void collectMetrics_delayInterrupted_andSuccessAndErrorBranches() {
        ...
        try {
            ...
            assertThat(response.metrics()).containsKey("ok").containsKey("bad");
        } finally {
            Thread.interrupted();
        }
    }
    ...
    void collectMetrics_handlesWebClientResponseExceptionBranch() {
        ...
        MetricsCollectionRequest req = new MetricsCollectionRequest(
                "task-http",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r", "GET", "http://localhost:9090/m", null, null, null)),
                0, null, null);

        MetricsCollectionResponse response = service.collectMetrics(req);
        assertThat(response.status()).isEqualTo("PARTIAL");
        assertThat(response.metrics().get("r")).isNotNull();
    }
    ...
    void collectMetrics_usesUrlAsKey_andHintBranchWithNullHost() {
        ...
        MetricsCollectionRequest req = new MetricsCollectionRequest(
                "task-key",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("   ", "GET", "http://:9090/u", null, null, null)),
                1, null, null);
        MetricsCollectionResponse response = service.collectMetrics(req);
        assertThat(response.status()).isEqualTo("PARTIAL");
        assertThat(response.metrics()).containsKey("http://:9090/u");
    }
    ...
    void collectMetrics_delayNull_skipsSleep_hitsLine75False() {
        ...
        MetricsCollectionRequest req = new MetricsCollectionRequest(
                "task-delay-null",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("ok", "GET", "http://localhost:9090/u", null, null, null)),
                null, null, null);
        MetricsCollectionResponse response = service.collectMetrics(req);
    ...
    void collectMetrics_errorMessageNull_branchLine98() {
        ...
        MetricsCollectionRequest reqNullMsg = new MetricsCollectionRequest(
                "task-null-msg",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r1", "GET", "http://localhost:9090/u1", null, null, null)),
                0, null, null);
        MetricsCollectionResponse nullMsgResp = service.collectMetrics(reqNullMsg);
        assertThat(nullMsgResp.status()).isEqualTo("FAILED");
    }
    ...
    void collectMetrics_nameOrServiceNotKnown_branchLine98() {
        ...
        MetricsCollectionRequest reqNameOrService = new MetricsCollectionRequest(
                "task-name-or-service",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r2", "GET", "http://prometheus:9090/u2", null, null, null)),
                0, null, null);
        MetricsCollectionResponse nameOrServiceResp = service.collectMetrics(reqNameOrService);
        assertThat(nameOrServiceResp.status()).isEqualTo("PARTIAL");
    }
    ...
    void collectMetrics_nameOrServiceNotKnown_withHostNull_hitsLine101False() {
        ...
        MetricsCollectionRequest req = new MetricsCollectionRequest(
                "task-host-null",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r3", "GET", "file:/tmp/metrics.json", null, null, null)),
                0, null, null);
    ...
    void collectMetrics_nameOrServiceNotKnown_withNonHttpUrl_remainsPartial() {
        ...
        MetricsCollectionRequest req = new MetricsCollectionRequest(
                "task-non-http",
                List.of(new MetricsCollectionRequest.MetricsRequestItem("r4", "GET", "mailto:test@example.com", null, null, null)),
                0, null, null);
