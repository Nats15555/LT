...
public interface KafkaOutboxRepository extends JpaRepository<KafkaOutboxEntity, UUID> {
    ...
    List<KafkaOutboxEntity> findByModuleAndStatusAndEventTypeAndNextAttemptAtLessThanEqualOrderByCreatedAtAsc(
            String module, String status, String eventType, OffsetDateTime now, Pageable pageable);
}
